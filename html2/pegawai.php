                                ...
                                <!-- simpan data -->
                                    <?php 
                                        ...
                                        if(isset($_POST['simpan'])){
                                            ...
                                            $simpan = mysqli_query($koneksi,"INSERT INTO data_pegawai SET nama='$nama',nip='$nip',pangkat='$pangkat',jabatan='$jabatan',bidang='$bidang' ");
...
<?php 
include"koneksi.php";
$panggildata = mysqli_query($koneksi,'SELECT * FROM data_pegawai ORDER BY idpegawai');
$no =1;

if(isset($_GET['cari'])){
  //  $panggildata = $_GET['cari'];
  $panggildata = mysqli_query($koneksi, "SELECT * FROM data_pegawai WHERE nama LIKE '%".$_GET['cari']."%' OR nip LIKE '%".$_GET['cari']."%'");
} else {
...
?>
                      ...
                      <tr>
                        ...
                        <button
                          ...
                          class="btn btn-primary"
                          data-bs-toggle="modal"
                          data-bs-target="#editkategori<?=$isi['idpegawai'];?>"
                        >
                          Edit
                        </button>
                    <!-- Modal edit data -->
                    <div class="modal fade" id="editkategori<?=$isi['idpegawai'];?>" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                    ...
                                    <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Nama</label>
                                    <input  type="hidden" name="id" value="<?=$isi['idpegawai'];?>" class="form-control" placeholder="Masukan Nama" />
                                    <input  type="text" name="nama" value="<?=$isi['nama'];?>" class="form-control" placeholder="Masukan Nama" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">NIP</label>
                                    <input name="nip" type="text" value="<?=$isi['nip'];?>" class="form-control" placeholder="Masukan NIP" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Pangkat</label>
                                    <input name="pangkat" type="text" value="<?=$isi['pangkat'];?>" class="form-control" placeholder="Masukan Pangkat" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Jabatan</label>
                                    <input name="jabatan" type="text" value="<?=$isi['jabatan'];?>" class="form-control" placeholder="Nama Jabatan" />
                                  </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Bidang</label>
                                    <input name="bidang" type="text" value="<?=$isi['bidang'];?>" class="form-control" placeholder="Nama Jabatan" />
                                  </div>
                                ...
                                <!-- koneksi edit data  -->
                                    <?php 
                                        ...
                                        if(isset($_POST['edit'])){
                                            ...
                                            $edit = mysqli_query($koneksi,"UPDATE data_pegawai SET 
                                            nama='$nama',
                                            nip='$nip',
                                            pangkat='$pangkat',
                                            jabatan='$jabatan' WHERE idpegawai=".$id );
                ...
                <!-- Modals tutup  -->
                          ...
                          <a href="hapuspegawai.php?idpegawai=<?=$isi['idpegawai']?>" onclick="return confirm('Apakah Nama Pegawai ini Mau di Hapus?')"   class="btn btn-danger">Hapus</a>
