<?php 
                    ...
                    session_start();
                    if($_SESSION['level']==""){
                      header("location:operator.php?pesan=belum_login");
                    }
                                ...
                                <!-- simpan data -->
                                    <?php 
                                        ...
                                        if(isset($_POST['simpan'])){
                                            ...
                                            $simpan = mysqli_query($koneksi,"INSERT INTO userlogin SET nama='$nama',nip='$nip',pangkat='$pangkat',jabatan='$jabatan' ");
...
<?php 
include"koneksi.php";
$panggildata = mysqli_query($koneksi,'SELECT * FROM userlogin ORDER BY iduser');
$no =1;

if(isset($_GET['cari'])){
  //  $panggildata = $_GET['cari'];
  $panggildata = mysqli_query($koneksi, "SELECT * FROM userlogin WHERE username LIKE '%".$_GET['cari']."%'");
} else {
...
?>
                      ...
                      <tr>
                        ...
                        <button
                          ...
                          class="btn btn-primary"
                          data-bs-toggle="modal"
                          data-bs-target="#editkategori<?=$isi['iduser'];?>"
                        >
                          Edit
                        </button>
                    <!-- Modal edit data -->
                    <div class="modal fade" id="editkategori<?=$isi['iduser'];?>" tabindex="-1" aria-hidden="true">
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              <div class="modal-header">
                              ...
                              <div class="modal-body">
                                    ...
                                    <input  type="hidden" name="id" value="<?=$isi['iduser'];?>" class="form-control" placeholder="Masukan Nama" />
                                ...
                                <div class="row">
                                  <div class="col mb-4">
                                    ...
                                    <input name="nip" type="text" value="<?=$isi['nip'];?>" class="form-control" placeholder="Masukan password" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                ...
                                <!-- koneksi edit data  -->
                                    <?php 
                                        ...
                                        if(isset($_POST['edit'])){
                                            ...
                                            $edit = mysqli_query($koneksi,"UPDATE userlogin SET 
                                            nama='$nama',
                                            nip='$nip',
                                            pangkat='$pangkat',
                                            jabatan='$jabatan' WHERE iduser=".$id );
                ...
                <!-- Modals tutup  -->
                          ...
                          <a href="hapuspegawai.php?iduser=<?=$isi['iduser']?>" onclick="return confirm('Apakah Nama Pegawai ini Mau di Hapus?')"   class="btn btn-danger">Hapus</a>
