             ...
             <form  action="" method="GET">
                <div class="navbar-nav align-items-center">
                    <div class="nav-item d-flex align-items-center">
                      ...
                      <i type="#"  class="bx bx-search fs-4 lh-0"></i>
                      <input
                        type="text"
                        class="form-control border-0 shadow-none"
                        placeholder="Dinas Kehutanan Provinsi Jambi"
                        aria-label="Search..."
                ...
                <div class="col-xxl">
                  <div class="card mb-4">
                    <div class="card-header d-flex align-items-center justify-content-between">
                      <h5 class="mb-0">Tambah Kwitansi</h5>
                      <small class="text-muted float-end">2024</small>
                    </div>
                    <div class="card-body">
                      <form action="kwitansi.php" method="post">
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-4">
                            <input name="nosppd" type="text"  id="nosppd" class="form-control" placeholder="XXX/Dishut-1.1/III/2024" />
                          </div>
                          <label class="col-1 col-form-label" for="basic-default-name">Tanggal SPPD</label>
                          <div class="col-sm-3">
                            <input type="text" name="tanggalspd" id="tanggalspd" class="form-control" placeholder="12 Maret 2024" />
                          </div>
                        </div>
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="col-sm-2">
                            <input type="text" name="harian" id="harian" class="form-control" placeholder="3" />
                          </div>
                        ...
                        <div class="row mb-4">
                          ...
                          <div class="col-sm-2">
                          <select name="transport" onchange="setTransport(this)" type="text" class="form-select" value="<?= $isi['#']; ?>"
                          ...
                          <div class="col-sm-2">
                            <input type="text" name="subdana" id="subdana" class="form-control" placeholder="APBD/APBN" />
                          </div>
                        </div>
                          ...
                          <div id="transport-wrapper">
                              <div class="row mb-3">
                                  ...
                                  <div class="col-sm-2">
                                      <input type="text" name="tp1" id="tp1" class="form-control" placeholder="2" />
                                  </div>
                                  <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                                  <div class="col-sm-2">
                                  ...
                                  <div class="col-sm-3">
                                      <input type="text" name="kettp1" id="kettp1"  class="form-control" placeholder="Tiket Jambi - Kerinci" />
                                  </div>
                              </div>
                              <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="basic-default-name">Transport 2</label>
                                  <div class="col-sm-2">
                                      <input type="text" name="tp2" id="tp2"  class="form-control" placeholder="2" />
                                  </div>
                                  <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                                  <div class="col-sm-2">
                                  ...
                                  <label class="col-sm-1 col-form-label" for="basic-default-name">Ket</label>
                                  <div class="col-sm-3">
                                      <input type="text" name="kettp2" id="kettp2"  class="form-control" placeholder="Tiket Jambi - Kerinci" />
                                  </div>
                              </div>
                              <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="basic-default-name">Transport 3</label>
                                  <div class="col-sm-2">
                                      <input type="text" name="tp3" id="tp3"  class="form-control" placeholder="2" />
                                  </div>
                                  <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                                  <div class="col-sm-2">
                                  ...
                                  <label class="col-sm-1 col-form-label" for="basic-default-name">Ket</label>
                                  <div class="col-sm-3">
                                      <input type="text" name="kettp3" id="kettp3"  class="form-control" placeholder="Tiket Jambi - Kerinci" />
                                  </div>
                              </div>
                              <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="basic-default-name">Transport 4</label>
                                  <div class="col-sm-2">
                                      <input type="text" name="tp4" id="tp4"  class="form-control" placeholder="1" />
                                  </div>
                                  <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                                  <div class="col-sm-2">
                                  ...
                                  <label class="col-sm-1 col-form-label" for="basic-default-name">Ket</label>
                                  <div class="col-sm-3">
                                      <input type="text" name="kettp4" id="kettp4"  class="form-control" placeholder="Tiket Jambi - Kerinci" />
                                  </div>
                              </div>
                              <div class="row mb-3">
                                  <label class="col-sm-2 col-form-label" for="basic-default-name">Transport 5</label>
                                  <div class="col-sm-2">
                                      <input type="text" name="tp5" id="tp5"  class="form-control" placeholder="1" />
                                  </div>
                                  <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                                  <div class="col-sm-2">
                                  ...
                                  <label class="col-sm-1 col-form-label" for="basic-default-name">Ket</label>
                                  <div class="col-sm-3">
                                      <input type="text" name="kettp5" id="kettp5"  class="form-control" placeholder="Tiket Jambi - Kerinci" />
                                  </div>
                              </div>
                          </div>
                         ...
                         <div class="row mb-3" id="kend-dinas-wrapper">
                          ...
                          <div class="col-sm-4">
                            <input type="text" name="keteranganbbm" id="keteranganbbm"  class="form-control" placeholder="Mobil Dinas BH XXX BBM Pertamax/Pertalite" />
                          </div>
                          <label class="col-1 col-form-label" for="basic-default-name">Liter</label>
                          <div class="col-sm-2">
                            <input type="text" name="liter" id="liter"  class="form-control" placeholder="40" />
                          </div>
                         ...
                         <!-- Akhir Kendaraan Dinas --> 
                          ...
                          <div class="col-sm-3">
                            <input type="text" name="ketpen1" id="ketpen1"  class="form-control" placeholder="Penginapan 1 Malam" />
                          </div>
                          <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                          <div class="col-sm-2">
                            <input type="text" name="satuanpen1" id="satuanpen1"  class="form-control" placeholder="40" />
                          </div>
                          <label class="col-sm-1 col-form-label" for="basic-default-name">Harga</label>
                          <div class="col-sm-2">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" name="hotel1" id="hotel1" class="form-control" placeholder="Penginapan 1 Malam" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-1">
                         ...
                         <!-- Akhir Penginapan --> 
                          ...
                          <label class="col-sm-2 col-form-label" for="basic-default-name">Penginapan 1</label>
                          <div class="col-sm-3">
                            <input type="text" name="ketpen2" id="ketpen2"  class="form-control" placeholder="Penginapan 1 Malam" />
                          </div>
                          <label class="col-1 col-form-label" for="basic-default-name">Satuan</label>
                          <div class="col-sm-2">
                            <input type="text" name="satuanpen2" id="satuanpen2" class="form-control" placeholder="40" />
                          </div>
                          <label class="col-sm-1 col-form-label" for="basic-default-name">Harga</label>
                          <div class="col-sm-2">
                          ...
                          <div class="row">
                              <div class="col-md-5">
                                  <div class="row mb-3">
                                      <label class="col-sm-5 col-form-label" for="basic-default-name">Nama Penginapan</label>
                                      <div class="col-sm-7">
                                          <input type="text" name="hotel2" id="hotel2" class="form-control" placeholder="Penginapan 1 Malam" />
                                      </div>
                                  </div>
                              </div>
                              <div class="col-md-1">
                        ...
                        <?php
                           ...
                           if (isset($_POST['simpan'])) {
                             ...
                             $addon2 = $_POST['addon2'];
                               ...
                               $simpan = mysqli_query($koneksi, "INSERT INTO kwitansi 
                                SET nosppd = '$nosppd',
