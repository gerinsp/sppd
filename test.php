                  ...
                  <div class="row gy-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                      ...
                      <div class="mt-3">
                        ...
                        <a href="cetak2.php" type="button" class="btn btn-success"  >Cetak Data</a>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  <div class="col mb-2">
                                    ...
                                    <textarea class="form-control" name="dalamrangka" id="dalamrangka" rows="3"></textarea>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-2">
                                ...
                                <div class="row">
                                  <div class="col mb-2">
                                    ...
                                    <select name="subkegiatan" type="text"  class="form-select" value="<?= $isi['subkegiatan']; ?>" id="subkegiatan" aria-label="Default select example" >
                                ...
                                <div class="row">
                                  <div class="col mb-2">
                                    ...
                                    <input name="norek" type="text" id="norek" class="form-control" placeholder="Kode Rekening" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-2">
...
if (isset($_GET['cari'])) {
  ...
  $panggildata = mysqli_query($koneksi, "SELECT * FROM listsppd WHERE nama LIKE '%" . $_GET['cari'] . "%' OR nip LIKE '%" . $_GET['cari'] . "%'");
} else {
                            ...
                            <div class="modal-body">  
                              ...
                              <div class="row">
                                ...
                                <div class="row">
                                  <div class="col mb-2">
                                    <label for="dalamrangka"  class="form-label">Dalam Rangka</label>
                                    <textarea class="form-control" name="dalamrangka" value="<?= $isi['dalamrangka']; ?>" id="dalamrangka" rows="3"></textarea>
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-2">
