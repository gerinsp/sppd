                ...
                <div class="card-body">
                  <div class="row gy-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                      ...
                      <small class="text-light fw-semibold">/Data User</small>
                      <div class="mt-3">
                          ...
                          <div class="modal-dialog" role="document">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                    ...
                                    <input  type="hidden" name="iduser" value="<?=$isi['iduser'];?>" class="form-control" placeholder="Masukan Nama" />
                                    <input  type="text" name="username" value="<?=$isi['username'];?>" class="form-control" placeholder="Masukan Nama" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Password</label>
                                    <input name="password" type="text" value="<?=$isi['password'];?>" class="form-control" placeholder="Masukan password" />
                                  </div>
                                </div>
                                <div class="row">
                                  <div class="col mb-4">
                                    <label for="nameBasic" class="form-label">Level</label>
                                    <input name="level" type="text" value="<?=$isi['level'];?>" class="form-control" placeholder="Masukan Pangkat" />
                                  </div>
                                </div>
